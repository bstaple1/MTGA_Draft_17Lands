...
- Step 8: Move the downloaded tier list to the directory containing the draft tool executable or main.py

- Step 9: Open the tier list in a text editor and add the set (all capitals) and the label (e.g. "meta": {"collection_date": "2/10/2022 5:39:37", "label": "Test", "set": "NEO", "version": 1},)
