...
WIN_RATE_OPTIONS = [DATA_FIELD_GIHWR, DATA_FIELD_OHWR,
                    DATA_FIELD_GPWR, DATA_FIELD_GNDWR, DATA_FIELD_GDWR]
...
CARD_TYPE_DICT = {
    ...
    CARD_TYPE_SELECTION_NON_LANDS: [CARD_TYPE_CREATURE, CARD_TYPE_PLANESWALKER, CARD_TYPE_INSTANT, CARD_TYPE_SORCERY, CARD_TYPE_ENCHANTMENT, CARD_TYPE_ARTIFACT],
