...
WIN_RATE_OPTIONS_VERSION_3 = [DATA_FIELD_OHWR, DATA_FIELD_GPWR]
WIN_RATE_OPTIONS = [DATA_FIELD_GIHWR] + WIN_RATE_OPTIONS_VERSION_3
NON_COLORS_OPTIONS = WIN_RATE_OPTIONS + [DATA_FIELD_IWD, DATA_FIELD_ALSA]
DECK_COLORS = [FILTER_OPTION_ALL_DECKS,"W","U","B","R","G","WU","WB","WR","WG","UB","UR","UG","BR","BG","RG","WUB","WUR","WUG","WBR","WBG","WRG","UBR","UBG","URG","BRG"]
COLUMN_OPTIONS = [FILTER_OPTION_AUTO] + NON_COLORS_OPTIONS + DECK_COLORS
DECK_FILTERS = [FILTER_OPTION_AUTO] + DECK_COLORS

COLUMN_2_DEFAULT = DATA_FIELD_ALSA
COLUMN_3_DEFAULT = FILTER_OPTION_ALL_DECKS
COLUMN_4_DEFAULT = FILTER_OPTION_AUTO
...
RESULT_FORMAT_WIN_RATE = "Win Rate (%)"
...
WIN_RATE_FIELDS_DICT = {
    DATA_FIELD_GIHWR : "gih",
    DATA_FIELD_OHWR  : "ngoh",
    DATA_FIELD_GPWR  : "ngp",
